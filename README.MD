...
I used AdminBro to have a control panel of my database. From there, the website administrator can delete or modify a post, a comment and delete a user if necessary. 
